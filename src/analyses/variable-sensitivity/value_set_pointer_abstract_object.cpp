...
using abstract_object_sett = value_set_pointer_abstract_objectt::abstract_object_sett;
  ...
  const abstract_object_sett &new_values) const
{
  ...
  auto result =
    std::dynamic_pointer_cast<value_set_pointer_abstract_objectt>(mutable_clone());
