...
void EXPECT_TOP(abstract_objectt::merge_result const &result);
...
void EXPECT_BOTTOM(abstract_objectt::merge_result const &result);
...
void EXPECT_UNMODIFIED(abstract_objectt::merge_result const &result)
{
...
template <class value_typet = abstract_objectt>
void EXPECT_MODIFIED(abstract_objectt::merge_result const &result)
{
  auto object = std::dynamic_pointer_cast<const value_typet>(result.object);
